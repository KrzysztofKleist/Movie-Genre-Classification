...
# Generates augmented images for all the genres
def main_all():
    ...
    # reader_tsv_file_path = "files/data_train_random.tsv"
    # writer_tsv_file_path = "files/data_train_random_aug_all.tsv"
    # data_test_separate_movies.tsv
    reader_tsv_file_path = "files/data_train_separate_movies.tsv"
    writer_tsv_file_path = "files/data_train_separate_movies_aug_all.tsv"
    ...
    # It generated new images in train set 70% of the times
    with open(writer_tsv_file_path, "w", newline="", encoding="utf-8") as tsv_file:
        ...
        for row in tqdm(data):
            if counter == 0:
                ...
                tsv_writer.writerow(row)
                # Check if the random number is less than 0.7 then do the augmentation
...
def main_rare_genres():
    ...
    # # data_train_random.tsv
    # reader_tsv_file_path = "files/data_train_random.tsv"
    # writer_tsv_file_path = "files/data_train_random_aug_rare.tsv"
    # data_test_separate_movies.tsv
    reader_tsv_file_path = "files/data_train_separate_movies.tsv"
    writer_tsv_file_path = "files/data_train_separate_movies_aug_rare.tsv"
    ...
    # Open the data_train_random_aug_all.tsv file for writing
    # It generated new images on rare examples of the train set
    # 90% of the times and 10% for the rest
    with open(writer_tsv_file_path, "w", newline="", encoding="utf-8") as tsv_file:
        tsv_writer = csv.writer(tsv_file, delimiter="\t")
        counter = 0
        ...
        for row in tqdm(data):
            if counter == 0:
                ...
                copy_image_to_new_dir("raw_frames/" + row[1])
                tsv_writer.writerow(row)
                # Check if the random number is less than 0.1 then do the augmentation
